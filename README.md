...
└── reports/                 # Test reports (excluded from version control)
```
...
Reports generated by Locust will appear in the `reports/` directory when tests complete. These files may include HTML summaries and CSV statistics.
